...
#define CONFIG_FLATFS_DEBUG_VFS             (CONFIG_FLATFS_DEBUG_ALL || 1)
#define CONFIG_FLATFS_DEBUG_FS              (CONFIG_FLATFS_DEBUG_ALL || 1)
#define CONFIG_FLATFS_DEBUG_BRTREE          (CONFIG_FLATFS_DEBUG_ALL || 1)
